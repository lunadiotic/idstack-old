            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    ...
                    <p class="text-muted font-13 m-b-30">
                        <a href="{{ route('admin.course.detail.create') }}" class="btn btn-primary pull-right show-modal" style="margin-top: -29px;" title="Create Data" id="{{ $course->id }}">Create Data</a>
                    </p>
