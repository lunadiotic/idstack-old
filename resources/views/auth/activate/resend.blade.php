...
<html>
    <head>
        ...
        <title>IDStack - @yield('title', 'Resend Activation Email')</title>
    ...
    <div class="wrapper-page">
        <div class="card-box">
            <div class="panel-heading">
                <h4 class="text-center"> Resend Activation E-Mail <strong>IDStack</strong></h4>
            </div>

            <div class="p-20">

            <form class="form-horizontal m-t-20" method="POST" action="{{ route('auth.activate.resend') }}">
                    {{ csrf_field() }}
